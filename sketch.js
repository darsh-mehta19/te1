...
function setup() {
 ...
 // bg = addAnimation("bgIMage",bgimg);
  ...
  ground = createSprite(displayWidth/3-400,displayHeight-550,displayWidth,20);
  ground.addImage("ground",groundImage);
  ground.x = ground.width /2-600;
  ground.velocityX = -4;
  
  invisibleGround = createSprite(displayWidth/3-400,displayHeight-550,displayWidth,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(displayWidth,displayHeight-565,10,40);
